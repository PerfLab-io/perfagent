      ...
      <div className="container relative mx-auto px-4 py-8 md:py-10">
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="flex-1 bg-background p-4">
            ...
            <p className="text-foreground opacity-90 text-lg max-w-xl">
          ...
          <div className="w-full lg:w-1/3 relative">
            ...
            <Card className="relative border border-border shadow-none bg-card rounded-none text-foreground dark:text-peppermint-950">
              <CardHeader>
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-baseline gap-2">
                    <span className="inline-block w-3 h-3 mt-1 flex-shrink-0">
                      <svg
                        width="100%"
                        height="100%"
                        viewBox="0 0 12 12"
