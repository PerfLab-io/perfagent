	...
	return (
		<main
			...
			className={cn(
				...
				'peer-data-[variant=inset]:m-2 peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 peer-data-[variant=inset]:ml-0 peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] peer-data-[variant=inset]:rounded-xl',
				className,
			)}
			{...props}
		/>
