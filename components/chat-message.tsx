...
export function ChatMessage({
  ...
  return (
    ...
    >
      {!isUser && (
        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-700 flex items-center justify-center">
          ...
          <div
            className={cn(
              ...
              isUser
                ...
                : "bg-background border border-border text-foreground group relative transition-all duration-300 hover:translate-x-1 hover:-translate-y-1 hover:shadow-[-4px_4px_0_hsl(var(--border-color))]",
            )}
          >
          ...
          <div className="mt-1">
            <div className="flex items-center justify-between mb-1">
              ...
              <button
                ...
                className="text-xs text-merino-400 hover:text-merino-800 dark:text-merino-800 dark:hover:text-merino-100 p-1 hover:bg-merino-100 dark:hover:bg-merino-900 rounded-md flex items-center gap-1"
              >
                {expanded ? (
                  <>
            ...
            {expanded && (
              <div
                className={cn(
                  "p-3 border border-border rounded-lg transition-all duration-300",
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-bold text-merino-800 dark:text-merino-200 truncate flex-1 mr-2">
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      isActiveReport
                        ? "bg-merino-600 text-white hover:bg-merino-700 border-merino-600"
                        : "bg-merino-100 text-merino-800 dark:bg-merino-800 dark:text-merino-100 hover:bg-merino-200 dark:hover:bg-merino-700 border-merino-300 dark:border-merino-700",
                      "min-w-[40px]",
                      "report-button",
                    )}
                ...
                <p className="text-sm text-foreground mt-2 italic line-clamp-2">
                  {getReportSnippet()}
                </p>
              </div>
            )}
