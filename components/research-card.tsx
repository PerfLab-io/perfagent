...
export function ResearchCard({
  ...
  return (
    <div className="space-y-4 mt-4">
      ...
      <Card className="group relative bg-card rounded-lg border border-border transition-all duration-300">
        <CardHeader
          className={cn(
            "font-mono text-midnight-950 dark:text-peppermint-950 bg-accent p-4 border-b border-border flex flex-row items-center justify-between",
            "rounded-t-lg",
            ...
            {steps.map((step, index) => (
              <div
                ...
                className={cn(
                  ...
                  step.status === "in-progress" &&
                    "bg-accent/10 translate-x-1 -translate-y-1 shadow-[-4px_4px_0_hsl(var(--border-color))]",
              ...
              >
                ...
                {step.expanded && (
                  <div className="mt-3 pl-12 text-sm text-foreground/90 dark:text-foreground/90 space-y-2 animate-in fade-in-50">
                    {step.id === "plan" && (
                      <>
      ...
      {showResults && (
        <Card
          className={cn(
            "group relative bg-background rounded-xl border-border transition-all duration-300 hover:translate-x-1 hover:-translate-y-1 hover:shadow-[-8px_8px_0_hsl(var(--border-color))] w-full",
          ...
          <CardContent className="p-4 pt-2">
            <div className="space-y-4">
              <div className="flex flex-wrap gap-2 mb-2">
                ...
                <Badge
                  variant="outline"
                  className="bg-indigo-100/50 text-indigo-800 dark:bg-indigo-800/50 dark:text-indigo-100 hover:bg-indigo-100 dark:hover:bg-indigo-700"
                >
                ...
                <Badge
                  variant="outline"
                  className="bg-peppermint-100/50 text-peppermint-800 dark:bg-peppermint-800/50 dark:text-peppermint-100 hover:bg-peppermint-100 dark:hover:bg-peppermint-700"
                >
                ...
                <Badge
                  variant="outline"
                  className="bg-merino-100/50 text-merino-800 dark:bg-merino-800/50 dark:text-merino-100 hover:bg-merino-100 dark:hover:bg-merino-700"
                >
              ...
              <div className="space-y-3">
                {results.map((result) => (
                  <div
                    key={result.id}
                    className={cn(
                      "border border-border/20 rounded-lg p-3 transition-all duration-200",
